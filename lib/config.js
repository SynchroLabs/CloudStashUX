...
exports.getConfig = function(configFile, overrides)
{
    ...
    // nconf.env();
    //
    // Parse env vars that start with "CLOUDSTASHUX__", with segments separated by "__", remove the prefix, put the values
    ...
    Object.keys(process.env).filter(function (key)
    {
        ...
        //
        return key.indexOf("CLOUDSTASHUX__") == 0;
    ...
    else if (process.env['CLOUDSTASHUX_CONFIG'])
    {
