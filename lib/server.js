...
module.exports = function(config)
{
    ...
    {
        // Allow scripts edited during dev to show up in browser in real-time
        //
        app.use('/public', express.static('public'))
    }
    else
    {
        // Let the browser cache scripts so the response is a little snappier
        //
        app.use('/public', express.static('public', { maxage: '2h' }))
    }
